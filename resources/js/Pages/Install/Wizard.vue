...
const FIELDS: Record<string, Field[]> = {
    ...
    ai_provider: [
        ...
        },
        {
            ...
            showIf: (v) => v.ai_provider !== 'null',
        },
        { name: 'openai_api_key', type: 'password', showIf: (v) => v.ai_provider === 'openai' || v.ai_fallback_provider === 'openai' },
        { name: 'openai_model', type: 'text', showIf: (v) => v.ai_provider === 'openai' || v.ai_fallback_provider === 'openai' },
        { name: 'gemini_api_key', type: 'password', showIf: (v) => v.ai_provider === 'gemini' || v.ai_fallback_provider === 'gemini' },
        { name: 'gemini_model', type: 'text', showIf: (v) => v.ai_provider === 'gemini' || v.ai_fallback_provider === 'gemini' },
        { name: 'openai_compatible_base_url', type: 'url', showIf: (v) => v.ai_provider === 'openai_compatible' || v.ai_fallback_provider === 'openai_compatible' },
        { name: 'openai_compatible_api_key', type: 'password', showIf: (v) => v.ai_provider === 'openai_compatible' || v.ai_fallback_provider === 'openai_compatible' },
        { name: 'openai_compatible_model', type: 'text', showIf: (v) => v.ai_provider === 'openai_compatible' || v.ai_fallback_provider === 'openai_compatible' },
    ],
...
const DEFAULTS: Record<string, Answers> = {
    ...
    ai_provider: {
        ai_provider: 'null', ai_fallback_provider: '',
