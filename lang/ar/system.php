...
return [
    ...
    'ai' => [
        ...
        'description' => 'إعداد متعدد المزوّدين للمستشار: اختر مزوّداً أساسياً ومزوّداً بديلاً اختيارياً وبيانات اعتماد لكل مزوّد.',
        'provider' => 'المزوّد الأساسي',
        'fallback_provider' => 'المزوّد البديل',
        'base_url' => 'العنوان الأساسي',
        'api_key' => 'مفتاح API',
        'model' => 'النموذج',
        'timeout' => 'المهلة بالثواني',
        'monthly_limit' => 'حد التكلفة الشهري (دولار)',
        'prompt_rate' => 'كلفة الإدخال (دولار لكل مليون رمز)',
        'completion_rate' => 'كلفة الإخراج (دولار لكل مليون رمز)',
        'test_connection' => 'اختبار الاتصال',
        'test_status' => [
            'connected' => 'متصل',
            'not_configured' => 'غير مهيأ',
            'auth_failed' => 'فشل التحقق من المفتاح',
            'rate_limited' => 'المزوّد قيّد عدد الطلبات',
            'timeout_or_unreachable' => 'تعذّر الوصول إلى المزوّد أو انتهت المهلة',
            'provider_error' => 'خطأ من المزوّد',
            'model_unavailable' => 'النموذج غير متوفر',
            'invalid_response' => 'استجابة غير صالحة من المزوّد',
            'invalid_request' => 'طلب غير صالح',
            'budget_exhausted' => 'تم بلوغ حد التكلفة الشهري',
            'breaker_open' => 'موقوف مؤقتاً بعد إخفاقات متكررة',
            'too_many_tests' => 'محاولات كثيرة — انتظر دقيقة',
            'unknown_provider' => 'مزوّد غير معروف',
            'request_failed' => 'فشل طلب الاختبار',
        ],
        'health' => [
            'title' => 'حالة الذكاء الاصطناعي',
            'available' => 'متاح',
            'unavailable' => 'غير متاح',
            'active_chain' => 'السلسلة الفعالة',
            'monthly_spend' => 'الإنفاق الشهري',
            'budget_exhausted' => 'تم بلوغ الحد',
            'rates_unset' => 'أسعار الرموز صفر، لذلك يسجَّل الإنفاق صفراً ولا يمكن أن يعمل الحد الشهري.',
            'breaker_open' => 'موقوف مؤقتاً',
