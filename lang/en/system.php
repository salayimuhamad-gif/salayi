...
return [
    ...
    'ai' => [
        'title' => 'AI provider',
        'description' => 'Multi-provider AI configuration for the advisor: choose a primary provider, an optional fallback, and per-provider credentials.',
        ...
        'prompt_rate' => 'Prompt cost (USD per 1M tokens)',
        'completion_rate' => 'Completion cost (USD per 1M tokens)',
        ...
        'test_status' => [
            ...
            'timeout_or_unreachable' => 'Provider unreachable or timed out',
            'provider_error' => 'Provider error',
            'model_unavailable' => 'Model unavailable',
            'invalid_response' => 'Unusable provider response',
            'invalid_request' => 'Invalid request',
            'budget_exhausted' => 'Monthly cost limit reached',
            'breaker_open' => 'Temporarily paused after repeated failures',
            'too_many_tests' => 'Too many tests — wait a minute',
        ...
        'health' => [
            ...
            'rates_unset' => 'Token rates are 0, so spend is recorded as zero and the monthly limit cannot trip.',
            'breaker_open' => 'temporarily paused',
