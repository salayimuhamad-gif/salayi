...
return [
    ...
    'typography' => [
        ...
        'hint' => 'Fonts and text size for the public site — applies immediately, no rebuild',
        'font_ckb' => 'Kurdish font',
        'font_ar' => 'Arabic font',
        'font_latin' => 'English font',
        'font_outfit' => 'Outfit (bundled)',
        'font_noto_sans' => 'Noto Sans',
        'font_system' => 'System font',
        'font_k24' => 'K24, falling back to Noto Kufi',
        'font_kufi' => 'Noto Kufi Arabic',
        'font_noto_sans_arabic' => 'Noto Sans Arabic',
        'scale' => 'Public text scale',
        'scale_default' => 'default',
        'scale_hint' => 'Scales all public text between 90% and 120%. Admin screens are not affected.',
        'preview' => 'Preview',
